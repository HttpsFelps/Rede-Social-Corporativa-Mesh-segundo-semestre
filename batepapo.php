                    ...
                    if (isset($_POST['search'])) {
                        ...
                        if (mysql_num_rows($result) > 0) {
                            while ($row = mysql_fetch_assoc($result)) {
                                ...
                                echo '<li class="contact-item" data-nome="' . htmlspecialchars($row['Nome']) . '" data-email="' . htmlspecialchars($row['Email']) . '">
            ...
            <div class="card">
                <div class="card-header msg_head">
                    <div class="d-flex bd-highlight">
                        <div class="img_cont">
                            <?php
                            // Verifica se um nome foi passado pela URL
                            if (isset($_GET['contato'])) {
                                ...
                                if (mysql_num_rows($result) > 0) {
                                    ...
                                    echo '<img src="' . $imagemSrc . '" class="rounded-circle user_img" style="width: 70px; height: 70px;">';
...
<script>
    ...
    item.addEventListener('click', function() {
        ...
        // Redireciona para a mesma página com o nome do contato como parâmetro na URL
        window.location.href = 'batepapo.php?contato=' + encodeURIComponent(nome);
    });
});
</script>
